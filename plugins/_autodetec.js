...
await this.sendMessage(m.chat, { text: `𝗔𝗵𝗼𝗿𝗮 @${m.messageStubParameters[0].split`@`[0]} 𝗘𝘀 𝗔𝗱𝗺𝗶𝗻 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼\n\n𝗚𝗿𝗮𝗰𝗶𝗮𝘀 𝗔: ${usuario}`, mentions: [m.sender, m.messageStubParameters[0], ...groupAdmins.map(v => v.id)] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
} else if (chat.detect && m.messageStubType == 30) {
await this.sendMessage(m.chat, { text: `𝗔𝗵𝗼𝗿𝗮 @${m.messageStubParameters[0].split`@`[0]} 𝗬𝗮 𝗡𝗼 𝗘𝘀 𝗔𝗱𝗺𝗶𝗻\n\n𝗚𝗿𝗮𝗰𝗶𝗮𝘀 𝗔: ${usuario}`, mentions: [m.sender, m.messageStubParameters[0], ...groupAdmins.map(v => v.id)] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
