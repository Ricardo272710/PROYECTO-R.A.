...
const smsRowner = () => { return `*Este Comando Solo Lo Puedo Usar Yo Y Mi Creador Yallico 🕷️*` }//NUMERO DE BOT
const smsOwner = () => { return `*Este Comando Solo Lo Puedo Usar Yo Y Mi Creador Yallico 🕷️*` }//OWNER
